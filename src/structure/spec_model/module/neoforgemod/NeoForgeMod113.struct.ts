...
import { ModsToml } from '../../../../model/neoforge/ModsToml.js'
import { BaseNeoForgeModStructure } from '../NeoForgeMod.struct.js'
import { MinecraftVersion } from '../../../../util/MinecraftVersion.js'
import { UntrackedFilesOption } from '../../../../model/nebula/ServerMeta.js'

export class NeoForgeModStructure113 extends BaseNeoForgeModStructure<ModsToml> {
    ...
    public isForVersion(version: MinecraftVersion, libraryVersion: string): boolean {
        return NeoForgeModStructure113.isForVersion(version, libraryVersion)
    }

    public getLoggerName(): string {
        return 'NeoForgeModStructure (1.13)'
    }
                ...
                if (entry.version === '${file.jarVersion}') {
                    ...
                    try {
                        ...
                        for (const key of keys) {
                            const match = NeoForgeModStructure113.IMPLEMENTATION_VERSION_REGEX.exec(key)
                            if (match != null) {
                                version = match[1]
                            }
                        }
